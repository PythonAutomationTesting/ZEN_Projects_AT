...
class Prathyusha:
    ...
    country_locator = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[6]/div/div[2]/div/div/div[2]/i'
    country_select = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[6]/div/div[2]/div/div/div[1]'
    save1_button = '//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[4]/button'
    ...
    def employee_contact_details(self):
        sleep(5)
        ...
        sleep(3)
        self.driver.find_element(by=By.XPATH, value=self.contact_details).click()
        sleep(2)
        # self.driver.find_element(by=By.XPATH, value=self.street1_locator).send_keys(self.street1)
        # sleep(2)
        # self.driver.find_element(by=By.XPATH, value=self.street2_locator).send_keys(self.street2)
        # sleep(3)
        # self.driver.find_element(by=By.XPATH, value=self.city_locator).send_keys(self.city)
        # sleep(5)
        # self.driver.find_element(by=By.XPATH, value=self.save1_button).click()
        # sleep(3)
        # self.driver.find_element(by=By.XPATH, value=self.country_locator).click()
        # sleep(3)
        # self.driver.find_element(by=By.XPATH, value=self.country_select).click()
...
Prathyusha().Browsing()
Prathyusha().employee_contact_details()
